			...
			if (Gui::BeginTabItem("Input Bindings"))
			{
				Gui::PushStyleVar(ImGuiStyleVar_FramePadding, originalFramePadding);
				{
					...
					SettingsGui::InputSettingsEntry settingsEntriesInput[] =
					{
						...
						{ &settings.Input.Timeline_ScaleItemTime_CustomD, "Timeline: Scale Item Time Custom D", },
						{ &settings.Input.Timeline_ScaleItemTime_CustomE, "Timeline: Scale Item Time Custom E", },
						{ &settings.Input.Timeline_ScaleItemTime_CustomF, "Timeline: Scale Item Time Custom F", },
