...
namespace PeepoDrumKit
{
	...
	constexpr SprTypeDesc SprDescTable[] =
	{
		...
		{ SprID::Game_NoteTxt_KaDon,				SprGroup::Game, u8"assets/graphics/game_note_txt_kadon.svg" },
		...
		{ SprID::Game_NoteTxt_Bomb,					SprGroup::Game, u8"assets/graphics/game_note_txt_bomb.svg" },
		{ SprID::Game_NoteTxt_Adlib,				SprGroup::Game, u8"assets/graphics/game_note_txt_adlib.svg" },
	...
	struct ChartGraphicsResources : NonCopyable
	{
		...
		b8 GetImageQuad(ImImageQuad& out, SprID spr, SprTransform transform, u32 colorTint, const SprUV& uv = SprUV::FromRect({0, 0}, {1, 1})) const;
		...
		inline void DrawSprite(ImDrawList* drawList, SprID spr, SprTransform transform, u32 colorTint = 0xFFFFFFFF, const SprUV& uv = SprUV::FromRect({ 0, 0 }, { 1, 1 }))
		{
